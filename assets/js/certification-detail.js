    ...
    try {
      ...
      content.innerHTML = `
        ...
        <dl class="profile-grid">
          <dt>主催名</dt><dd>${toDisplayText(certification.organizer)}</dd>
          <dt>資格名</dt><dd>${toDisplayText(certification.name)}</dd>
          <dt>合格名</dt><dd>${toDisplayText(certification.result)}</dd>
